...
import 'package:nutrition_ai/controllers/main_auth_controller.dart';

class LoginScreen extends StatelessWidget {
  const LoginScreen({super.key});

  final Color primaryBlue = const Color(0xFF2979FF);
  final Color secondaryBlue = const Color(0xFF0D47A1);
  final Color darkText = Colors.white;
  final Color lightText = Colors.white70;
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelStyle: GoogleFonts.poppins(
              color: focusedController.value ? primaryBlue : lightText,
              fontSize: 14,
            ),
            prefixIcon: Icon(
              icon,
